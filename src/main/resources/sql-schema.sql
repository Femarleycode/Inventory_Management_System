...
CREATE TABLE if not exists ims.orderline (order_id int NOT NULL, item_id int NOT NULL, FOREIGN KEY (item_id) REFERENCES ims.items (item_id), FOREIGN KEY (order_id) REFERENCES ims.orders (order_id));
